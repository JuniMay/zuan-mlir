//===- Unrolling.cpp - Dyno Unrolling Utilities -----------------*- C++ -*-===//
//
// This file implements the unrolling utilities for Dyno operations.
//
//===----------------------------------------------------------------------===//
...
#define DEBUG_TYPE "dyno-unrolling"
...
Operation *unrollOp(OpBuilder &builder, Operation *op, UnrollOptions options,
  ...
  if (auto iface = dyn_cast<DynoUnrollingInterface>(op)) {
