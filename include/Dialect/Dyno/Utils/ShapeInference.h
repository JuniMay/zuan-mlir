//===- ShapeInference.h - Local shape reification for Dyno -----*- C++ -*-===//
//
// This file declares local, demand-driven shape reification helpers for Dyno.
//
//===----------------------------------------------------------------------===//

#ifndef DYNO_UTILS_SHAPEINFERENCE_H
#define DYNO_UTILS_SHAPEINFERENCE_H
...
/// Reify the full shape of a Dyno tile value on demand.
///
...
/// Reify one dimension of a Dyno tile value on demand.
///
/// This is the scalar counterpart to `reifyDynoShape`: it returns either a
...
/// Rewrite direct `dyno.dim` users of a tile result into plain index values.
///
...
#endif // DYNO_UTILS_SHAPEINFERENCE_H
