...
func.func @masked_add(%a: memref<?xf32>, %b: memref<?xf32>, %m: memref<?xi1>, %dst: memref<?xf32>, %maskedoff: memref<?xf32>) {
  zuan.dynamic (%dst : memref<?xf32>) {
  ^bb0(%dst_tile: !zuan.tile<?xf32>):
